...
public class MainActivity extends AppCompatActivity {
    ...
    public void onConfigurationChanged(@NonNull Configuration newConfig) {
        ...
        // 로그를 남긴다.
        Log.i("superdroid", "onConfigurationChanged()");

        // 만일 시스템 환경이 변경되면 화면 레이아웃을 다시 설정한다
        setContentView(R.layout.activity_main);     // onConfigurationChanged()가 호출됐을 때는 이미 방향 전환이 된 상태이므로 이 레이아웃은 가로 방향일 때의 레이아웃임
    }
