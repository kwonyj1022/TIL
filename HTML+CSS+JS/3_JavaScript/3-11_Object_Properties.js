...
/* 11-1 객체 속성에 접근하기 */
    ...
    */
    ...
    console.log(person["fullname"]);            // 실행결과 : Hong Gildong
    console.log(person["age"]);                 // 실행결과 : 20
    console.log(person["name"]);                // 실행결과 : { firstName: 'Gildong', lastName: 'Hong }
    console.log(person["name"]["firstName"]);   // 실행결과 : Gildong
    console.log(person["likes"]);               // 실행결과 : [ 'apple', 'samsung' ]
    console.log(person["likes"][0]);            // 실행결과 : apple
    console.log(person["likes"][1]);            // 실행결과 : samsung
    console.log(person["printHello"]);          // 실행결과 : [Function: printHello]
    console.log(person["printHello"]());        // 실행결과 : hello
    console.log(person["phone number"]);        // 실행결과 : 010-000-0000
    ...
    */
    console.log(person.name.lastName);  // 실행결과 : Hong
    console.log(person.age);            // 실행결과 : 20
    console.log(person.likes[0]);       // 실행결과 : apple
    console.log(person.printHello());   // 실행결과 : hello
...
/* 11-2 객체 속성 값 변경하기 */
    ...
    */
    person.name = "Kim";
    console.log(person.name);   // 실행결과 : Kim
...
/* 11-3 객체 속성 동적으로 추가하기 */
    ...
    */
    const obj = {};         // 빈 객체 생성
    console.log(obj);       // 실행결과 : {}
    obj.job = "teacher";    // job 속성 추가
    console.log(obj);       // 실행결과 : { job: 'teacher' }
...
/* 11-5 객체의 데이터 관리 방법 이해하기 */
    ...
    */
    ...
    num = 20;               // 변수 num을 재할당
    console.log(num);       // 실행결과 : 20
    console.log(copyNum);   // 실행결과 : 10
    ...
    console.log(man.name);      // 실행결과 : Hong
    console.log(copyMan.name);  // 실행결과 : Hong
